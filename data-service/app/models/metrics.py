...
from sqlalchemy import BIGINT, DateTime, Float, Integer, String
...
class MetricSnapshot(Base):
    ...
    memory_bytes: Mapped[int] = mapped_column(BIGINT, nullable=True)

    restart_count: Mapped[int] = mapped_column(Integer, nullable=True)
