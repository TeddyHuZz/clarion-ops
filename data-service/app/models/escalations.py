...
class EscalationPolicy(Base):
    ...
    level_1_user: Mapped[str | None] = mapped_column(String(255), nullable=True)
    level_2_user: Mapped[str | None] = mapped_column(String(255), nullable=True)
    level_3_user: Mapped[str | None] = mapped_column(String(255), nullable=True)
